...
export default async function UserReflectionsPage({ params }: { params: Promise<{ userId: string }> }) {
  ...
  const posts = moduleVisible ? await getPosts("reflections", ownerId, visibleTo(level)) : []
