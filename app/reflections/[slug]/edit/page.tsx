...
export default async function EditReflectionPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <PostEditorClient mode="edit" type="reflections" typeLabel={dict.nav.reflections} userId={userId} initialData={post} creator={creator} workspaceNav={workspaceNav} />
}
