...
const zhCN: Dictionary = {
  ...
  ai: {
    ...
    heroTitle: "让 AI 助手更自然地接入你的站内工作流",
    heroDescription: "这里会保留会话记录，并按你的权限读取可访问的数据。新的执行视图会把思考、工具调用和最终回答分开呈现。",
...
const enUS: Dictionary = {
  ...
  ai: {
    ...
    heroTitle: "Let AI naturally integrate into your workflow",
    heroDescription: "Conversation history is preserved here, with data access scoped to your permissions. The new execution view separates thinking, tool calls, and final answers.",
    ...
    loadAiFailed: "Failed to load AI assistant",
